                  ...
                  { playlists.length > 0 ? (
                      playlists.map((playlist, i) => (
                        <li className="playlistLink" key={i}>
                          <p>
                            <Link to={`/branches/${branch._id}/playlist/${playlist._id}`} >{i+1}. {playlist.name} </Link>
                            <span>
                            <IconButton
                              aria-label="Delete"
          ...
          <div className="headAndPlaylistcontainer">
            ...
            <div className="playlist">
              <Switch>
                ...
                <Route path={`${props.match.url}/create`} render={props => <CreatePlaylist branchId={branch._id} setPlaylists={setPlaylists} {...props}/> } />
              </Switch>
            </div>
          </div>
